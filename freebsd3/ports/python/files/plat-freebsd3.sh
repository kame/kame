...
#
#	plat-freebsd3
#	plat-freebsd3/FCNTL.py
#	plat-freebsd3/SOCKET.py
#	plat-freebsd3/TERMIOS.py
#	plat-freebsd3/IN.py
#
echo c - plat-freebsd3
mkdir -p plat-freebsd3 > /dev/null 2>&1
echo x - plat-freebsd3/FCNTL.py
sed 's/^X//' >plat-freebsd3/FCNTL.py << 'END-of-plat-freebsd3/FCNTL.py'
...
XLOCK_NB = 0x04
XLOCK_UN = 0x08
END-of-plat-freebsd3/FCNTL.py
echo x - plat-freebsd3/SOCKET.py
sed 's/^X//' >plat-freebsd3/SOCKET.py << 'END-of-plat-freebsd3/SOCKET.py'
...
Xdef __COPYRIGHT(s): return __IDSTRING(copyright,s)
X
END-of-plat-freebsd3/SOCKET.py
echo x - plat-freebsd3/TERMIOS.py
sed 's/^X//' >plat-freebsd3/TERMIOS.py << 'END-of-plat-freebsd3/TERMIOS.py'
...
XCRPRNT = CREPRINT
XCFLUSH = CDISCARD
END-of-plat-freebsd3/TERMIOS.py
echo x - plat-freebsd3/IN.py
sed 's/^X//' >plat-freebsd3/IN.py << 'END-of-plat-freebsd3/IN.py'
...
X
Xdef IN_EXPERIMENTAL(i): return (((long)(i) & 0xf0000000) == 0xf0000000)
X
Xdef IN_BADCLASS(i): return (((long)(i) & 0xf0000000) == 0xf0000000)
X
XINADDR_ANY = 0x00000000
XINADDR_LOOPBACK = 0x7f000001
XINADDR_BROADCAST = 0xffffffff
XINADDR_NONE = 0xffffffff
XINADDR_UNSPEC_GROUP = 0xe0000000
XINADDR_ALLHOSTS_GROUP = 0xe0000001
XINADDR_ALLRTRS_GROUP = 0xe0000002
XINADDR_MAX_LOCAL_GROUP = 0xe00000ff
XIN_LOOPBACKNET = 127
XIP_OPTIONS = 1
XIP_HDRINCL = 2
XIP_TOS = 3
...
XIPCTL_MAXID = 14
XIP_NAT_IN = 0x00000001
XIP_NAT_OUT = 0x00000002
END-of-plat-freebsd3/IN.py
exit
