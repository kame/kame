...
#
#	plat-freebsd2
#	plat-freebsd2/FCNTL.py
#	plat-freebsd2/SOCKET.py
#	plat-freebsd2/IN.py
#	plat-freebsd2/TERMIOS.py
#
...
XLOCK_NB = 0x04
XLOCK_UN = 0x08
END-of-plat-freebsd2/FCNTL.py
echo x - plat-freebsd2/SOCKET.py
sed 's/^X//' >plat-freebsd2/SOCKET.py << 'END-of-plat-freebsd2/SOCKET.py'
...
Xdef __COPYRIGHT(s): return __IDSTRING(copyright,s)
X
END-of-plat-freebsd2/SOCKET.py
echo x - plat-freebsd2/IN.py
sed 's/^X//' >plat-freebsd2/IN.py << 'END-of-plat-freebsd2/IN.py'
...
XIPPORT_HIFIRSTAUTO = 40000
XIPPORT_HILASTAUTO = 44999
...
END-of-plat-freebsd2/IN.py
echo x - plat-freebsd2/TERMIOS.py
sed 's/^X//' >plat-freebsd2/TERMIOS.py << 'END-of-plat-freebsd2/TERMIOS.py'
...
XCRPRNT = CREPRINT
XCFLUSH = CDISCARD
END-of-plat-freebsd2/TERMIOS.py
exit
